...
fetch("https://api.countrystatecity.in/v1/countries", requestOptions)
  ...
  .then(result =>{
    ...
    $(countryHolderSelector).each(function (i, element){
      generateSelectDropdown($(element).find(countryInput), 'selector-country-js', 'Select country');
...
$(document).on('change', stateSelector, function (){
  ...
  fetch(url, requestOptions)
    ...
    .then(result => {
      ...
      generateSelectDropdown(currentBody.find(cityInput), 'selector-city-js', 'Select city');
